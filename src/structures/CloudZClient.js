...
const CloudZEvents = require("./CloudZEvents");
const CloudZCommands = require("./CommandHandler");
const config = require(`../../config.json`);
const Shoukaku = require("./Shoukaku");
const Lavasfy = require("./Lavasfy");
const web = new WebhookClient({url : errors});
class CloudZ extends Client {
    constructor(){
        super({
        ...
        this.CloudZCommands = new CloudZCommands(this).loadCommands();
        this.events = new CloudZEvents(this).loadEvents();
