...
class CloudZReady extends CloudZClientEvent{
    get name(){
        return 'ready';
    }
    async run(){
        console.log(`${this.client.user.username} is Online!`);
        let statuses = [`${this.client.config.prefix}help Quality Improved`,`${this.client.config.prefix}play`, 'Back To Original Node']
        setInterval(() => {
